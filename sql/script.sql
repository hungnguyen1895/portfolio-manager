...
VALUES (1, ''hung'', ''nguyen'', ''hungnguyen'', ''123456''),
       (2, ''jessica'', ''phelan'', ''jessphelan'', ''123456''),
       (3, ''jovanny'', ''vera'', ''jovannyvera'', ''123456'');

INSERT INTO cash_account (id, user_id, account_name, value)
VALUES (1, 1, ''Citi'', 3127.12),
...
INSERT INTO investment (id, user_id, stock_name, quantity, stock_symbol)
VALUES (1, 1, ''TESLA'', 31.25, ''TSLA''),
       (2, 1, ''Apple'', 20, ''AAPL''),
       (3, 1, ''Citi'', 200, ''C'');